...
function onDeviceReady() {
  $(document).ready(function () {
    ...
    $("form").submit(async function (event) {
      ...
      await $.post(tokenUrl, adminDet, function (data, status) {
      ...
      $(".login").hide();
      $(".view").show();
      $(".app-title").append(`  Welcome ${userDet.name}, make a report today.`);
      $(".app-page").show();
    });
    ...
    $("#validated").click(function () {
      ...
      const formData = {
        ...
        content: `<img src=${data} alt=an-img /><p>${contents}</p><p>${location}</p>`,
        status: "publish",
      };
